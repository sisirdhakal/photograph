...
const AboutSection = (props: Props) => {
    return (
        <div className='px-24 py-10 bg-[#F3F1E9]'>
            <div className='grid grid-cols-aboutSection gap-28'>
                ...
                <div className='w-full pt-4'>
                    ...
                    <p className='text-[15.2px] leading-6 font-medium text-[#454543] mb-14 '>
                    ...
                    <h2 className='text-[21.34px] text-clrgrey1 leading-9 mb-8'>
                        Freezing life’s most important <br />
                    ...
                    <button className='bg-[#b9b1a7] hover:bg-[#81817A] mt-8 py-2 text-[1rem] px-6 lg:px-10 text-white block mx-auto rounded-xs transition-all ease-linear duration-300 hover:text-clrgrey2'>
                        The Experience
                    </button>
                </div>
            </div>
