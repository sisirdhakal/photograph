...
const Infos = (props: Props) => {
    return (
        <div className='bg-[#F3F1E9] px-8 w-full  py-10'>
            <div className='md:w-[64%] mx-auto'>
                <h1 className='text-[#454543] text-center font-medium tracking-wide text-3xl mb-3'>Kind Words</h1>
                <p className='text-[14.2px] md:text-[15.2px] leading-6 font-medium text-[#454543] mb-6 md:text-center mx-auto'>
                ...
                <p className='text-[15.2px] leading-6 font-medium text-[#454543] mb-8 capitalize text-center'>
                    - maria
                </p>

                <p className='text-[15.2px] leading-6 tracking-widest text-[#81817a] capitalize text-center cursor-pointer mx-auto underline'>Read More</p>
            </div>
        </div>
    )
}
